...
class Laporan extends CI_Controller
{
    ...
    public function laporan_pdf_buku()
    {
        ...
        ob_end_clean();
        $this->dompdf->stream("laporan_data_buku.pdf", array('Attachment' => true)); // nama file pdf yang di hasilkan 
    ...
    { {
            ...
            $this->dompdf->load_html($html);
            ob_end_clean();
            $this->dompdf->stream("laporan_data_peminjaman.pdf", array('Attachment' => true)); // nama file pdf yang di hasilkan 
    ...
    public function Laporan_anggota()
    {
        ...
        $data['anggota'] = $this->role->getRole();
    ...
    { {
            ...
            $this->dompdf->load_html($html);
            ob_end_clean();
            $this->dompdf->stream("laporan_data_anggota.pdf", array('Attachment' => true)); // nama file pdf yang di hasilkan 
